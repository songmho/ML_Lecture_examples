...
Date: 2020. 09. 08.
Programmer: MH
Description: Code for predicting Bike rant demanding
"""
import pandas as pd
...
class BikeRentDemandPredictor:
    ...
    def train_model(self):
        ...
        dump(self.dtr, "./Bike_Rent_Demand_predictor.joblib")
    ...
    def predict(self, X):
        ...
        """
        self.dtr = load("./Bike_Rent_Demand_predictor.joblib")
    ...
    def finetune_model(self, criterion="mse", max_depth=None, min_samples_leaf=1, max_leaf_nodes=None ):
        ...
        self.dtr.fit(self.train_X, self.train_y)
        print(self.dtr.get_n_leaves(), self.dtr.get_depth())
        dump(self.dtr, "./Bike_Rent_Demand_predictor.joblib")     # To save trained model to local
    ...
    def visualize_tree(self):
        ...
        :return:
        """
        tree.export_graphviz(self.dtr, out_file="Bike_Rent_Demand_predictor.dot", feature_names=self.feature_names,
                             class_names=self.class_names, filled=True)


if __name__ == '__main__':
    rrp = BikeRentDemandPredictor()
    rrp.load_dataset("../dataset/Seoul Bike Sharing Demend Dataset/SeoulBikeData.csv")
    ...
    rrp.finetune_model(max_depth=100)
